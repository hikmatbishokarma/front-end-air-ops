    ...
    <Box sx={{ mt: 5 }}>
      ...
      <div className="space-y-2">
        <p>
          ...
          {FlightCategoryEnum[allFormValues.category as FlightCategoryKey] ||
            "N/A"}
        </p>
        <p>
        ...
        >
          ...
          <tbody>
            {allFormValues.sectors?.length > 0 ? (
              allFormValues.sectors.map((item: any, index: number) => (
                <tr key={index}>
                  <td style={{ border: "1px solid #ccc", padding: "8px" }}>
            ...
            >
              ...
              <tbody>
                {allFormValues.prices?.length > 0 ? (
                  allFormValues.prices.map((item: any, index: number) => (
                    <tr key={index}>
                      <td style={{ border: "1px solid #ccc", padding: "8px" }}>
                        {item.label}
                      </td>
