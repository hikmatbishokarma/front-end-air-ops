...
const ManualControllerPage = () => {
  ...
  // --- DATE FILTER STATES ---
  const [finalGqlFilter, setFinalGqlFilter] = useState<IManualFilter>({});
  ...
  return (
    <>
      ...
      <ManualList filter={finalGqlFilter} open={open} setOpen={setOpen} />
