...
import { CREATE_AIRCRAFT_CATEGORY, GET_AIRCRAFT_CATEGORIES, GET_AIRCRAFT_CATEGORY_BY_ID, UPDATE_AIRCRAFT_CATEGORY } from '../../lib/graphql/queries/aircraft-categories';
import useGql from '../../lib/graphql/gql';
import { useSnackbar } from '../../SnackbarContext';
import { GET_AIRCRAFT_DETAIL_BY_ID, UPDATE_AIRCRAFT_DETAIL } from '../../lib/graphql/queries/aircraft-detail';
...
export const AircraftDetailEdit=({id, onClose,refreshList})=>{
   ...
   const [aircraftCategories, setAircraftCategories] = useState<
      ...
      useEffect(() => {
       ...
       useEffect(() => {
          if (aircraftDetailData) {
            ...
            setValue('category',aircraftDetailData.category || "")
          }
      ...
      useEffect(()=>{getAircraftCategories()},[])
        ...
        <Grid container spacing={1} alignItems="center" sx={{ mb: 3 }}>
          ...
          <Grid item xs={6}>
                    ...
                    <Controller
                        ...
                        render=
                        {({ field }) => (
                          <TextField {...field} size="small" label="Description" fullWidth multiline />
                        )}
                      />
                    </Grid>
                    <Grid item xs={8}>
                                   <Controller
                                     ...
                                     render={({ field }) => (
                                      ...
                                      value={aircraftCategories.find((aircraft:any) => aircraft.id === field.value) || null}
