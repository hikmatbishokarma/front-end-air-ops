                      ...
                      >
                        ...
                        <Grid item xs={6}>
                          <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                              <TextField {...field} size="small" label="Title" fullWidth InputLabelProps={{ shrink: !!field.value }} />
                            )}
                          />
                        </Grid>
                        <Grid item xs={5}>
                          <Controller
                            ...
                            control={control}
                            render={({ field }) => (
                              <TextField {...field} size="small" label="Value" fullWidth InputLabelProps={{ shrink: !!field.value }}  />
                            )}
                          />
                        </Grid>
