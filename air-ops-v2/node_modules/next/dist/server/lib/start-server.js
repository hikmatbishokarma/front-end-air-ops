"use strict";
/* build-hook-start *//*00001*/try { require('/Users/hikmat.bk/.cursor/extensions/wallabyjs.console-ninja-1.0.489-universal/out/buildHook/index.js').default({tool: 'next.js', checkSum: '20249b3b5c1eac217e6396AwEXUB1TDwFXUFlRCldWXVACDlIH', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///Users/hikmat.bk/.cursor/extensions/wallabyjs.console-ninja-1.0.489-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20249b3b5c1eac217e6396AwEXUB1TDwFXUFlRCldWXVACDlIH', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
