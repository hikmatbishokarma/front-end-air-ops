...
} from "./chunk-UV4UI6XD.js";
import {
  Skeleton_default,
  Tabs_default
} from "./chunk-UZWCUFYS.js";
import {
  createPopper
} from "./chunk-2IFQMZDE.js";
import {
  Typography_default,
  useMediaQuery_default
} from "./chunk-RVUDFNGQ.js";
import {
  ButtonGroupContext_default,
  Button_default
} from "./chunk-NRTBRECY.js";
import {
  IconButton_default
} from "./chunk-74D6YRVB.js";
import {
  CircularProgress_default
} from "./chunk-THHJEU4S.js";
import {
  InitColorSchemeScript_default,
  ThemeProvider,
  useColorScheme,
  useThemeProps
} from "./chunk-DIGUQ7J3.js";
import {
  Close_default
} from "./chunk-U3XUNOJY.js";
import {
  isMuiElement_default,
  useId_default
} from "./chunk-4Q6PAYCH.js";
import {
  capitalize_default
} from "./chunk-SHJX2CTS.js";
import {
  memoTheme_default
} from "./chunk-6U56JYK2.js";
import {
  useDefaultProps
} from "./chunk-7PREV26M.js";
import {
  createTheme,
  styled_default
} from "./chunk-6DAVINQQ.js";
import {
  createUnarySpacing,
  getValue,
  handleBreakpoints,
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime10.jsxs)(React43.Fragment, {
...
function useFloating(options) {
  ...
  const [data, setData] = React57.useState({
    x: 0,
    y: 0,
    strategy,
    placement,
  ...
  const dataRef = React57.useRef(data);
...
var Portal = React58.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React58.useState(null);
  const handleRef = useForkRef(React58.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React58.isValidElement(children)) {
      ...
      return React58.cloneElement(children, newProps);
    }
    return children;
  }
...
var TransitionContext = React59.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React60.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React61.useState(true);
  const hasPendingExitTransition = React61.useRef(false);
  const registeredTransitions = React61.useRef(0);
  const [hasTransition, setHasTransition] = React61.useState(false);
  const previousRequestEnter = React61.useRef(requestEnter);
  React61.useEffect(() => {
  ...
  const registerTransition = React61.useCallback(() => {
...
var PopupContext = React62.createContext(null);
if (true) {
...
var Popup = React63.forwardRef(function Popup2(props, forwardedRef) {
  ...
  const popupContextValue = React63.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React64.forwardRef(function Menu2(props, forwardedRef) {
  const {
    actions,
    anchor: anchorProp,
    children,
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React65.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React66.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    label,
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = React67.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
var InnerMenuItem = React69.memo(React69.forwardRef(function MenuItem(props, forwardedRef) {
  const {
    children,
    disabled: disabledProp = false,
    label,
...
var MenuItem2 = React69.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function useModal(parameters) {
  ...
  const modal = React70.useRef({});
  const mountNodeRef = React70.useRef(null);
  const modalRef = React70.useRef(null);
  const handleRef = useForkRef(modalRef, rootRef);
  const [exited, setExited] = React70.useState(!open);
  ...
  const isTopModal = React70.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var Modal = React71.forwardRef(function Modal2(props, forwardedRef) {
  const {
    children,
    closeAfterTransition = false,
    container,
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React73.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React73.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React73.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React74.forwardRef(function NumberInput2(props, forwardedRef) {
  const {
    className,
    defaultValue,
    disabled,
...
var OptionGroup = React75.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {},
...
function useOption(params) {
  ...
  const selectOption = React76.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
function useOptionContextStabilizer(value) {
  const listContext = React77.useContext(ListContext);
  if (!listContext) {
  ...
  const localGetItemState = React77.useCallback((itemValue) => {
    if (itemValue !== value) {
  ...
  const localContextValue = React77.useMemo(() => ({
    dispatch,
    getItemState: localGetItemState
  }), [dispatch, localGetItemState]);
  return {
...
var InnerOption = React78.forwardRef(function InnerOption2(props, forwardedRef) {
  var _a, _b;
  const {
    children,
    disabled = false,
...
var InnerOptionMemo = React78.memo(InnerOption);
var Option = React78.forwardRef(function Option2(props, ref) {
  const {
    value
  } = props;
  const {
...
var PopperTooltip = React79.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const tooltipRef = React79.useRef(null);
  const ownRef = useForkRef(tooltipRef, forwardedRef);
  const popperRef = React79.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React79.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React79.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React79.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React79.useState(resolveAnchorEl(anchorEl));
  React79.useEffect(() => {
...
var Popper = React79.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
function useSelect(props) {
  ...
  const optionValues = React80.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React80.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React80.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    return (option == null ? void 0 : option.disabled) ?? false;
  }, [getOptionByValue]);
  const stringifyOption = React80.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React80.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React80.useCallback((itemValue) => {
    var _a;
    return (_a = options.get(itemValue)) == null ? void 0 : _a.id;
  }, [options]);
  const handleSelectionChange = React80.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React80.useCallback((event, newValue) => {
    onHighlightChange == null ? void 0 : onHighlightChange(event, newValue ?? null);
  }, [onHighlightChange]);
  const handleStateChange = React80.useCallback((event, field, fieldValue) => {
    var _a;
    if (field === "open") {
  ...
  const getItemDomElement = React80.useCallback((itemId) => {
    var _a;
    if (itemId == null) {
      return null;
    }
  ...
  const isInitiallyOpen = React80.useRef(open);
  useEnhancedEffect_default(() => {
    var _a;
  ...
  const getOptionMetadata = React80.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
...
function defaultRenderValue(selectedOptions) {
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime24.jsx)(React82.Fragment, {
...
var Select = React82.forwardRef(function Select2(props, forwardedRef) {
  const {
    areOptionsEqual,
    autoComplete,
    autoFocus,
  ...
  const [buttonDefined, setButtonDefined] = React82.useState(false);
  ...
  const handleButtonRefChange = React82.useCallback((element) => {
  ...
  return (0, import_jsx_runtime24.jsxs)(React82.Fragment, {
...
var Slider = React84.forwardRef(function Slider2(props, forwardedRef) {
  const {
    "aria-label": ariaLabel,
  ...
  return (0, import_jsx_runtime25.jsxs)(Root, {
    ...
    children: [(0, import_jsx_runtime25.jsx)(Rail, {
      ...
      return (0, import_jsx_runtime25.jsxs)(React84.Fragment, {
...
var Snackbar = React86.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React88.forwardRef(function Switch2(props, forwardedRef) {
  const {
    checked: checkedProp,
    defaultChecked,
    disabled: disabledProp,
...
var TablePaginationActions = React89.forwardRef(function TablePaginationActions2(props, forwardedRef) {
  const {
    count,
...
var TablePagination = React90.forwardRef(function TablePagination2(props, forwardedRef) {
  const {
    colSpan: colSpanProp,
    count,
...
function useTabs(parameters) {
  ...
  const onSelected = React91.useCallback((event, newValue) => {
    setValue2(newValue);
  ...
  const tabIdLookup = React91.useRef(() => void 0);
  const getTabPanelId = React91.useCallback((tabValue) => {
    var _a;
    return (_a = tabPanels.get(tabValue)) == null ? void 0 : _a.id;
  }, [tabPanels]);
  const getTabId2 = React91.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React91.useCallback((lookupFunction) => {
...
var TabsContext = React92.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React92.useContext(TabsContext);
  if (context == null) {
...
function TabsProvider(props) {
  ...
  const tabsContextValue = React93.useMemo(() => ({
    direction,
    getTabId: getTabId2,
    getTabPanelId,
    onSelected,
...
var Tabs = React94.forwardRef(function Tabs2(props, forwardedRef) {
  const {
    children,
    value: valueProp,
    defaultValue,
...
function useTabPanel(parameters) {
  ...
  const metadata = React95.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React96.forwardRef(function TabPanel2(props, forwardedRef) {
  const {
    children,
    value,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React97.useCallback((tabValue) => {
    var _a;
    return (_a = subitems.get(tabValue)) == null ? void 0 : _a.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React97.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React97.useCallback((tabValue) => {
    var _a;
    if (tabValue == null) {
      return null;
    }
  ...
  const handleChange = React97.useCallback((event, newValue) => {
    onSelected(event, newValue[0] ?? null);
  }, [onSelected]);
  const controlledProps = React97.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React97.useCallback((item) => {
    var _a;
  ...
  const {
    ...
    reducerActionContext: React97.useMemo(() => ({
...
function TabsListProvider(props) {
  ...
  const listContextValue = React98.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
...
var TabsList = React99.forwardRef(function TabsList2(props, forwardedRef) {
  const {
    children,
    slotProps = {},
    slots = {},
...
function useTab(parameters) {
  ...
  const tabMetadata = React100.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var Tab = React101.forwardRef(function Tab2(props, forwardedRef) {
  const {
    action,
    children,
    disabled = false,
...
var TextareaAutosize = React102.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const {
    current: isControlled
  } = React102.useRef(value != null);
  const inputRef = React102.useRef(null);
  const handleRef = useForkRef(forwardedRef, inputRef);
  const heightRef = React102.useRef(null);
  const shadowRef = React102.useRef(null);
  const calculateTextareaStyles = React102.useCallback(() => {
  ...
  const syncHeight = React102.useCallback(() => {
  ...
  return (0, import_jsx_runtime36.jsxs)(React102.Fragment, {
...
var LoadingButton = React106.forwardRef(function LoadingButton2(inProps, ref) {
...
var LocalizationProvider = React107.forwardRef(function DeprecatedLocalizationProvider() {
  warn15();
  return null;
});
...
var MobileDatePicker = React108.forwardRef(function DeprecatedMobileDatePicker(props, ref) {
  warn16();
  return null;
});
...
var MobileDateRangePicker = React109.forwardRef(function DeprecatedMobileDateRangePicker() {
  warn17();
  return null;
});
...
var MobileDateTimePicker = React110.forwardRef(function DeprecatedMobileDateTimePicker() {
  warn18();
  return null;
});
...
var MobileTimePicker = React111.forwardRef(function DeprecatedMobileTimePicker() {
  warn19();
  return null;
});
...
var MonthPicker = React112.forwardRef(function DeprecatedMonthPicker() {
  warn20();
  return null;
});
...
var Pagination_default2 = React113.forwardRef(function DeprecatedPagination(props, ref) {
  warn21();
...
var PaginationItem_default2 = React114.forwardRef(function DeprecatedPaginationItem(props, ref) {
  warn22();
...
var CalendarPickerSkeleton = React115.forwardRef(function DeprecatedCalendarPickerSkeleton() {
  warn23();
  return null;
});
...
var PickersDay = React116.forwardRef(function DeprecatedPickersDay() {
  warn24();
  return null;
});
...
var Rating_default2 = React117.forwardRef(function DeprecatedRating(props, ref) {
  warn25();
...
var Skeleton_default2 = React118.forwardRef(function DeprecatedSkeleton(props, ref) {
  warn26();
...
var SpeedDial_default2 = React119.forwardRef(function DeprecatedSpeedDial(props, ref) {
  warn27();
...
var SpeedDialAction_default2 = React120.forwardRef(function DeprecatedSpeedDialAction(props, ref) {
  warn28();
...
var SpeedDialIcon_default2 = React121.forwardRef(function DeprecatedSpeedDialIcon(props, ref) {
  warn29();
...
var StaticDatePicker = React122.forwardRef(function DeprecatedStaticDatePicker() {
  warn30();
  return null;
});
...
var StaticDateRangePicker = React123.forwardRef(function DeprecatedStaticDateRangePicker() {
  warn31();
  return null;
});
...
var StaticDateTimePicker = React124.forwardRef(function DeprecatedStaticDateTimePicker() {
  warn32();
  return null;
});
...
var StaticTimePicker = React125.forwardRef(function DeprecatedStaticTimePicker() {
  warn33();
  return null;
});
...
var Context = React126.createContext(null);
if (true) {
  Context.displayName = "TabContext";
}
function useUniquePrefix() {
  const [id, setId] = React126.useState(null);
  React126.useEffect(() => {
...
function useTabContext() {
  return React126.useContext(Context);
}
...
var TabList = React127.forwardRef(function TabList2(props, ref) {
  const {
...
var TabPanel3 = React128.forwardRef(function TabPanel4(inProps, ref) {
...
var TimePicker = React129.forwardRef(function DeprecatedTimePicker() {
  warn34();
  return null;
});
...
var TimelineContext = React130.createContext({});
if (true) {
...
var Timeline = React131.forwardRef(function Timeline2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeline"
  });
...
var TimelineConnector = React132.forwardRef(function TimelineConnector2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineConnector"
  });
...
var TimelineContent = React133.forwardRef(function TimelineContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineContent"
  });
...
var TimelineDot = React134.forwardRef(function TimelineDot2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineDot"
  });
...
var TimelineOppositeContent = React135.forwardRef(function TimelineOppositeContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineOppositeContent"
  });
...
var TimelineItem = React136.forwardRef(function TimelineItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineItem"
  });
  ...
  React136.Children.forEach(props.children, (child) => {
...
var TimelineSeparator = React137.forwardRef(function TimelineSeparator2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineSeparator"
  });
...
var ToggleButton_default2 = React138.forwardRef(function DeprecatedToggleButton(props, ref) {
  warn35();
...
var ToggleButtonGroup_default2 = React139.forwardRef(function DeprecatedToggleButtonGroup(props, ref) {
  warn36();
...
var TreeItem = React140.forwardRef(function DeprecatedTreeItem() {
  warn37();
  return null;
});
...
var TreeView = React141.forwardRef(function DeprecatedTreeView() {
  warn38();
  return null;
});
...
var Masonry = React142.forwardRef(function Masonry2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React142.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React142.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React142.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = {
    ...props,
    spacing,
    columns,
  ...
  const handleResize = React142.useCallback((masonryChildren) => {
...
var DialogsContext = React143.createContext(null);
...
function DialogsProvider(props) {
  ...
  const [stack, setStack] = React145.useState([]);
  const keyPrefix = React145.useId();
  const nextId2 = React145.useRef(0);
  const requestDialog = React145.useCallback(function open(Component, payload, options = {}) {
    const {
      onClose = async () => {
      }
    } = options;
  ...
  const closeDialogUi = React145.useCallback(function closeDialogUi2(dialog) {
  ...
  const closeDialog = React145.useCallback(async function closeDialog2(dialog, result) {
...
function useStorageState(area, key, initializer = null, options) {
  ...
  const [initialValue] = React146.useState(initializer);
  const encodedInitialValue = React146.useMemo(() => encode(codec, initialValue), [codec, initialValue]);
  const subscribeKey = React146.useCallback((callback) => subscribe(area, key, callback), [area, key]);
  const getKeySnapshot = React146.useCallback(() => getSnapshot(area, key) ?? encodedInitialValue, [area, encodedInitialValue, key]);
  const encodedStoredValue = React146.useSyncExternalStore(subscribeKey, getKeySnapshot, getKeyServerSnapshot);
  const storedValue = React146.useMemo(() => decode(codec, encodedStoredValue), [codec, encodedStoredValue]);
  const setStoredValue = React146.useCallback((value) => {
  ...
  const [nonStoredValue, setNonStoredValue] = React146.useState(initialValue);
  if (!key) {
...
function LegacyThemeProvider(props) {
  ...
  const dualAwareTheme = React147.useMemo(() => isDualTheme ? theme[paletteMode === "dark" ? "dark" : "light"] ?? theme[paletteMode === "dark" ? "light" : "dark"] : theme, [isDualTheme, paletteMode, theme]);
  const paletteModeContextValue = React147.useMemo(() => ({
    paletteMode,
...
var AuthenticationContext = React148.createContext(null);
var SessionContext = React148.createContext(null);
...
@mui/lab/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZMBSG3JB.js.map
